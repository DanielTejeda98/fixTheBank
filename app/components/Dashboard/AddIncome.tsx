        ...
        <DrawerBody className="flex-col w-full">
          <div className="mt-2 w-full">
            ...
            <Input
              ...
              onChange={(e) =>
                formDispatch({ amount: formatCurrencyInput(e.target.value) })
              }
            />
          ...
          <div className="mt-2 w-full">
            ...
            <Input
              ...
              onChange={(e) => formDispatch({ source: e.target.value })}
            />
            ...
            <div className="flex w-full gap-2 mt-1">
              {dateButtonOnLeft ? (
                <Button
                  type="button"
                  onClick={(e) =>
                    formDispatch({ date: formatDateInput(new Date()) })
                  }
                >
                  Today
                </Button>
              ...
              <Input
                ...
                name="date"
                value={formData.date}
                onChange={(e) => formDispatch({ date: e.target.value })}
              />
              {!dateButtonOnLeft ? (
                <Button
                  type="button"
