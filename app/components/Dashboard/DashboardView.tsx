...
export default function DashboardView({budget }: {budget: BudgetView }) {
    ...
    const transactions = useAppSelector(selectTransactions).sort((a, b) => new Date(a.transactionDate || a.date).getTime() - new Date(b.transactionDate || b.date).getTime()).slice(0,10)
