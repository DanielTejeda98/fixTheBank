  ...
  if (transaction) {
    return {
      ...
      account:
        ...
        "",
      category:
        categories.find((cat) => cat._id === transaction.category)?._id ||
        categories[0]?._id ||
        "",
    ...
    >
      ...
      <DrawerBody className="flex-col w-full">
        ...
        <div className="mt-2 w-full">
          ...
          {isEdit && transaction.receiptImage && (
            <Link
              href={`/api/images/${budgetId}/${transaction.receiptImage}`}
              target="_blank"
            >
        ...
        <div className="mt-2 w-full">
          ...
          <Input
            ...
            onChange={(e) =>
              dispatch({ amount: formatCurrencyInput(e.target.value) })
            }
          />
        ...
        <div className="mt-2 w-full">
          ...
          <Select
            ...
            onValueChange={(e: string) => dispatch({ account: e })}
            name="account"
          >
            <SelectTrigger>
        ...
        <div className="mt-2 w-full">
          ...
          <Select
            ...
            onValueChange={(e: string) => dispatch({ category: e })}
            name="category"
          >
            <SelectTrigger>
        ...
        <div className="mt-2 w-full">
          ...
          <div className="flex w-full gap-2 mt-1">
            {dateButtonOnLeft ? (
              <Button
                type="button"
                onClick={(e) => dispatch({ date: formatDateInput(new Date()) })}
              >
                Today
              </Button>
            ) : null}
        ...
        {formData.giftTransaction ? (
          <div className="mt-2 w-full">
            ...
            <Input
              type="date"
              name="revealGiftDate"
              value={formData.revealGiftDate}
              onChange={(e) => dispatch({ revealGiftDate: e.target.value })}
            />
            {validator.current.message(
              "revealGiftDate",
        ...
        {formData.splitPayments ? (
          <div className="mt-2 w-full">
            ...
            <Input
              ...
              onChange={(e) =>
                dispatch({ numberOfPayments: Number(e.target.value) })
              }
            />
            {validator.current.message(
              "numberOfPayments",
        ...
        <Collapsible
          asChild
          open={furtherOptionsOpen}
          onOpenChange={setFurtherOptionsOpen}
        >
