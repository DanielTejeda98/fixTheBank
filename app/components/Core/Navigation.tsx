    ...
    <nav className="sticky bottom-0 inset-x-0 h-20 pt-1 w-full self-end transition-all backdrop-blur-sm border-t">
      <ul className="grid grid-row-4 grid-flow-col mt-2 mx-2">
        <li>
          <Link
            href="/dashboard"
            className={`flex flex-col p-1 gap-1 items-center ${
              pathname?.includes("/dashboard") ? "rounded-lg border" : ""
            }`}
          >
        ...
        <li>
          <Link
            href="/planner"
            className={`flex flex-col p-1 gap-1 items-center ${
              pathname?.includes("/planner") ? "rounded-lg border" : ""
            }`}
          >
            <div className="w-7 h-7 rounded-full text-center">
        ...
        <li>
          <Link
            href="/savings"
            className={`flex flex-col p-1 gap-1 items-center ${
              pathname?.includes("/savings") ? "rounded-lg border" : ""
            }`}
          >
            <div className="w-7 h-7 rounded-full text-center">
        ...
        <li>
          <Link
            href="/settings"
            className={`flex flex-col p-1 gap-1 items-center ${
              pathname?.includes("/settings") ? "rounded-lg border" : ""
            }`}
          >
            <div className="w-7 h-7 rounded-full text-center">
